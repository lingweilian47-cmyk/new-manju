...
## **V6.9 小说三阶段接入版** · Short-Drama Director Suite

> 🎨 面向 **AIGC 视听创作** 的工业化全流程技能包
> 从创意立项到视频模型投喂提示词 —— 给 AI 助手 / LLM 直接调用

![Version](https://img.shields.io/badge/版本-V6.9--小说接入版-6a5acd)
![Modules](https://img.shields.io/badge/规则库-44%20模块-00b4d8)
![Files](https://img.shields.io/badge/文件-51-2ec4b6)
...
```
📚 小说入口：S1影视化增补 → S2抖音优化 → S3基础分镜 → 🖼️ 资产锁定 → 📐 Work技术施工 → 🚀 Seedance 2.5七段式无时间码 → ✅ 独立质检

🧩 原创入口：📋 立项锁定 → ✍️ 门控编剧 → 🎙️ 台词诊断 → 🖼️ 资产锁定 → 🎬 分镜 → 🚀 提示词封装 → ✅ 独立质检
```
...
- **V6.9 小说三阶段接入版** — 新增 S1/S2/S3 小说入口、P1-N 导入门、Work 技术施工、Seedance 2.5 七段式无时间码合同与 novel profile 机检
